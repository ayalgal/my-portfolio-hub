    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `אתה יועץ השקעות AI חכם שעוזר למשתמשים לנהל את הפורטפוליו שלהם. אתה מדבר עברית.
תענה על שאלות על:
- אסטרטגיות דיבידנד
- הקצאת נכסים ופיזור
- ניתוח מניות בסיסי
- מיסוי דיבידנדים בישראל ובחו"ל
- טיפים כלליים לניהול פורטפוליו

אל תיתן עצות ספציפיות לקנייה/מכירה. הדגש תמיד שזו לא ייעוץ השקעות רשמי.
תענה בקצרה ותמציתית.`
          },
          ...messages,
        ],
